package com.example.Stream;// Java 프로그래밍 - 스트림
...
//      2-3. Sorting
        ...
        IntStream intStream4 = IntStream.builder().add(5).add(4).add(3).add(2).build();
...
//      3-3. reduce
        ...
        Stream<Integer> stream3 = new ArrayList<Integer>(Arrays.asList(1, 2, 3, 4)).stream();
